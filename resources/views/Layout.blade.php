...
<head>
  ...
  <!-- jQuery -->
  <link rel="icon" type="image/png" href="{{ url('public\DualSysco.ico') }}">
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a href="{{route('AdminGroup')}}" class="nav-link">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Admin Groups</p>
                    </a>
                  </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="{{route('TeamMember')}}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Team Members</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="{{route('Productivities')}}" class="nav-link">
