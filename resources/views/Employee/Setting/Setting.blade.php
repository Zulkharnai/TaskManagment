...
function Getdata() {
    ...
    columns: [{
        ...
        },
        {
            data: 'user_status',
            render: (user_status) => {
                    return `<p>${user_status == 0 ? "Deactivate" : "Active"}</p>`;
                }
        },
        {
            data: 'group_name',
        ...
        },
        {
            data: 'user_id',
            render: (user_id) => {
                    return `<button class="btn btn-primary mx-1" data-toggle="modal" data-target="#UserStoreModal" onclick="UserEdit('${user_id}')" ><i class="fa fa-edit"></i></button>`;
                }
        }
